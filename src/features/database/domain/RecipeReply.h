...
class RecipeReply : public RecipesReply
{
    Q_OBJECT
public:
    explicit RecipeReply(const QUrl &url, QNetworkAccessManager * const networkManager, int recipeId, int loudsNumber = Default::AttemptsNumber, QObject *parent = nullptr);
